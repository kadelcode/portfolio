    ...
    return (
        <section className='py-12 bg-gray-100 dark:bg-gray-800 dark:text-gray-50 min-h-screen'>
            <div className='container mx-3 md:mx-auto'>
                ...
                {skills.map((category) => (
                    <div key={category.category} className='mb-8 mx-3 md:mx-7'> {/* Added margin bottom for spacing */}
                        ...
                        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 box-border'>
                            {category.items.map((skill) => (
                                <div key={skill.name} className='bg-white dark:bg-gray-700 p-6 rounded-lg shadow box-border'>
